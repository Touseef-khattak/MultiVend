        ...
        <div id="content">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9"><!--Col md 9 starting-->
                        <div class="box box-details">
                            ...
                            <form action="confirm.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="trans_number" class="form-control">
                                </div>
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary btn-lg" name="confirm_payment">Confirm</button>
                                </div>
