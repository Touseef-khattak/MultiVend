        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6"><!-- col-md-3 col-sm-6 Start -->
                ...
                <ul>
                    ...
                    <li><a href="#">Women's Wearing</a></li>
                    <li><a href="#">Men's Wearing</a></li>
...
<div id="copyright"><!-- Copy Right Section End-->
    <div class="container">
        <div class="col-md-6">
            <p class="pull-left">Template by: <a href="#">MultiMatix.com</a></p>
        </div>
        <div class="col-md-6">
            <p class="pull-right">&copy; 2019 by MultiMatix IT solution</p>
        </div>
    </div>
</div>
